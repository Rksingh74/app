...
def load_generator(generator_path):
    generator = Generator(img_feat=3, n_feats=64, kernel_size=3, num_block=16)  # Adjust parameters if necessary
...
def reduce_noise(image, noise_reduction_level):
    # Apply stronger Gaussian Blur for higher noise reduction levels
...
def main():
    ...
    if uploaded_file is not None:
        ...
        generator_path = "D:/clg/sem 6/Srgan project/SRGAN_CustomDataset-main/model/pre_trained_model_4488.pt"
        ...
        # Display images side by side with gaps
